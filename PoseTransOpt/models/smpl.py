...
try:
    ...
    from lib.smplx.body_models import ModelOutput as SMPLOutput
except Exception as e:
    # from smplx.body_models import SMPLOutput
    from lib.smplx.body_models import SMPLOutput
...
class SMPL(_SMPL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        J_regressor_extra = np.load('models/J_regressor_extra.npy')
